...
#include "MainView/SQLTableScene/CustomComboBox/CustomComboBox.h"
...
const QMetaObject CustomComboBox::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CustomComboBox.data,
      qt_meta_data_CustomComboBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CustomComboBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsRectItem"))
        return static_cast< QGraphicsRectItem*>(const_cast< CustomComboBox*>(this));
